    ...
    <div class="app h-screen w-full grid  grid-cols-6 text-base">
        <div class="col-span-1 w-full max-h-screen bg-[#262948] relative">
            ...
            <div class="w-full absolute bottom-0 py-8 px-6 text-white font-semibold">
                ...
                @auth
                    <a class="flex justify-start items-center gap-4 py-2 hover:text-red-500"
                ...
                @else
                    <div class="flex justify-start items-center gap-4 py-2 hover:text-red-500" onclick="openModal('loginModal')">
                        <i class="fa-solid fa-right-from-bracket"></i>
                        <p>Log In</p>
                    </div>
                    @if (Route::has('register'))
                        <div class="flex justify-start items-center gap-4 py-2 hover:text-red-500" onclick="openModal('registerModal')">
        ...
        <div class="col-span-5 w-full max-h-screen bg-[#3c425e]">
            <div class="grid grid-cols-2 gap-1 h-full overflow-scroll overflow-x-hidden">
                <!-- column 2-->
                <div class="col-span-1 h-full bg-[#202441] text-white text-base w-full pl-12 pr-12 py-8">
                    ...
                    <div class="alert alert-success alert-dismissible fade d-flex" role="alert" style="margin-left: 13px;margin-right: 13px;">
                    ...
                    @if(Auth::check())	
                        ...
                        <div id="my-rooms" class="w-full pl-4 mt-12 scroll-smooth">
                        ...
                        <div id="rooms-joined" class="w-ful pl-4 mt-12 scroll-smooth">
...
@section("script")
    <script>
        ...
        function turnOnNotification(message, type){
            ...
            let notificationMessageElement = $('#notification-'+type+'-message');
                    ...
                    let html = `<a href="#" class="w-full bg-[#262948] hover:bg-[#4289f3] py-3 px-4 my-4 rounded-lg grid grid-cols-3 gap-2 relative">
                        <div class="col-span-1">
                            <div class="flex justify-start items-center gap-4">
                                ...
                                <p class="font-bold">`+ data.roomName + `</p>
                            </div>
                        </div>
